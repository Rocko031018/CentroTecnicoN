        ...
        fetch("/Categoria/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    swal("Completado", "La categoria fue creada", "success")
                }
                else {
        ...
        fetch("/Categoria/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Completado", "La categotia fue editada", "success")
                }
                else {
                    swal("Cancelado", responseJson.mensaje, "error")
                }
                ...
                fetch(`/Categoria/Eliminar?IdCategoria=${data.idCategoria}`, {
                    ...
                    .then(responseJson => {
                        if (responseJson.estado) {
                            ...
                            swal("Completado", "La categoria fue eliminada", "success")
                        }
                        else {
                            swal("Cancelado", responseJson.mensaje, "error")
                        }
