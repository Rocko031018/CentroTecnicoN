...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdBrand).HasName("PK__Brand__E353A48E0A0E9ED4");
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C03ADB3EE");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FB9A4C00B");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4838AD9AD13");
        ...
        {
            entity.HasKey(e => e.IdModel).HasName("PK__ModelPho__144F1E55E686B63C");
            ...
            entity.HasOne(d => d.IdBrandNavigation).WithMany(p => p.ModelPhones)
                ...
                .HasConstraintName("FK__ModelPhon__idBra__71D1E811");
        });

        modelBuilder.Entity<Negocio>(entity =>
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107412D4502");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E642C7FEF");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1322851753E");
        ...
        {
            entity.HasKey(e => e.IdRep).HasName("PK__Repair__3C8791D6BD75DF5D");
            ...
            entity.HasOne(d => d.ClientNavigation).WithMany(p => p.Repairs)
                ...
                .HasConstraintName("FK__Repair__client__7E37BEF6");

            entity.HasOne(d => d.IdBrandNavigation).WithMany(p => p.Repairs)
                .HasForeignKey(d => d.IdBrand)
                .HasConstraintName("FK__Repair__idBrand__7F2BE32F");

            entity.HasOne(d => d.IdModelNavigation).WithMany(p => p.Repairs)
                .HasForeignKey(d => d.IdModel)
                .HasConstraintName("FK__Repair__idModel__00200768");
        });

        modelBuilder.Entity<Rol>(entity =>
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76B9F4F105");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8887DA75D");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE56766895");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A67E6ED85E");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614028A29CC");
