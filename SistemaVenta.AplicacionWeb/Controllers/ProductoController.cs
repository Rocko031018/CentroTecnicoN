...

{
    ...
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Crear([FromBody] IFormFile imagen, [FromBody] string modelo)
        {
        ...
        public async Task<IActionResult> Editar([FromBody] IFormFile imagen, [FromForm] string modelo)
        {
