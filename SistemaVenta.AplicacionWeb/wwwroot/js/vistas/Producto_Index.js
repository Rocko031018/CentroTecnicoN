...
function mostrarModal(modelo = MODELO_BASEp) {
        ...
        fetch("/Producto/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    swal("Completado", "El producto fue creado", "success")
                }
                else {
        ...
        fetch("/Producto/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Completado", "El producto fue editado", "success")
                }
                else {
                    swal("Cancelado", responseJson.mensaje, "error")
                }
                ...
                fetch(`/Producto/Eliminar?IdProducto=${data.idProducto}`, {
                    ...
                    .then(responseJson => {
                        if (responseJson.estado) {
                            ...
                            swal("Completado", "El producto fue eliminado", "success")
                        }
                        else {
                            swal("Cancelado", responseJson.mensaje, "error")
                        }
